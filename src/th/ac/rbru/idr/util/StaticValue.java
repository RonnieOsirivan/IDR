...
public class StaticValue implements ServletContextListener{
	...
	public static String REPORT_COMPLETE_OTHER_TECH_THAI;
	public static String REPORT_COMPLETE_OTHER_TECH_THAI_DOCX;
...
//			input = new FileInputStream("/Users/rattasit/workspace/IDR/fileconf/config.properties");
			...
			REPORT_COMPLETE_OTHER_TECH_THAI = prop.getProperty("report_complete_other_tech_thai");
			REPORT_COMPLETE_OTHER_TECH_THAI_DOCX = prop.getProperty("report_complete_other_tech_thai_docx");
